...
# pred_maps = preds[1]
# preds = preds[0]
# np.save(os.path.join(save_path, "allmaps_bbox2017.npy"), allmaps)
# np.save(os.path.join(save_path, "predmaps_bbox2017.npy"), pred_maps)
# np.save(os.path.join(save_path, "preds_bbox2017.npy"), preds)
...
##save data
np.save(os.path.join(save_path, "true_preds_2017.npy"), true_preds)
np.save(os.path.join(save_path, "allmaps_nobbox2017.npy"), allmaps)
np.save(os.path.join(save_path, "predmaps_nobbox2017.npy"), pred_maps)
np.save(os.path.join(save_path, "preds_nobbox2017.npy"), preds)
