...
IMG_URL = "http://vision.stanford.edu/aditya86/ImageNetDogs/thumbnails/n02085782-Japanese_spaniel/n02085782_1353.jpg"
...
for idx in idxs:
    ...
    heatmap(cam, img_path=img_path, save_name="imgs/cam_keras_{}".format(labels[idx][1]))
